                ...
                <div className="flex items-center gap-2.5 text-foreground font-bold text-xl tracking-tight select-none mb-8">
                    ...
                    <div className="flex flex-col justify-center text-left leading-none">
                        <div className="flex items-center text-lg md:text-xl font-extrabold tracking-tight">
                            <span className="bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent">Medi</span>
                            <span className="ml-1 text-teal-400">Track</span>
                        </div>
                        <span className="text-[10px] font-medium text-neutral-500 tracking-widest uppercase mt-0.5">Hopital Management Syestem</span>
                    </div>
                </div>
